...
${OBJECTDIR}/BufferedImage.o: BufferedImage.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BufferedImage.o BufferedImage.cpp
...
${OBJECTDIR}/HOGFeature.o: HOGFeature.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HOGFeature.o HOGFeature.cpp

${OBJECTDIR}/HOGProcessor.o: HOGProcessor.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HOGProcessor.o HOGProcessor.cpp
...
${OBJECTDIR}/ImageExtractor.o: ImageExtractor.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImageExtractor.o ImageExtractor.cpp
...
${OBJECTDIR}/Matfile.o: Matfile.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Matfile.o Matfile.cpp

${OBJECTDIR}/MatfileReader.o: MatfileReader.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MatfileReader.o MatfileReader.cpp

${OBJECTDIR}/OpenCLUtils.o: OpenCLUtils.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OpenCLUtils.o OpenCLUtils.cpp

${OBJECTDIR}/PedestrianDetectionBenchmark.o: PedestrianDetectionBenchmark.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PedestrianDetectionBenchmark.o PedestrianDetectionBenchmark.cpp

${OBJECTDIR}/PerformanceLap.o: PerformanceLap.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PerformanceLap.o PerformanceLap.cpp

${OBJECTDIR}/ReferenceSubImage.o: ReferenceSubImage.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReferenceSubImage.o ReferenceSubImage.cpp

${OBJECTDIR}/SVMClassifier.o: SVMClassifier.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SVMClassifier.o SVMClassifier.cpp

${OBJECTDIR}/SeqFileHeader.o: SeqFileHeader.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SeqFileHeader.o SeqFileHeader.cpp

${OBJECTDIR}/SeqFileReader.o: SeqFileReader.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SeqFileReader.o SeqFileReader.cpp
...
${OBJECTDIR}/XWindow.o: XWindow.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XWindow.o XWindow.cpp
